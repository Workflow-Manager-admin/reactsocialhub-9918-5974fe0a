...
By default, the backend runs on port 3000, so the React frontend has been configured to run on port 3001 instead.  
If you use `npm start`, the app will be accessible at [http://localhost:3001](http://localhost:3001).
